...
/**
 * PersonasEntidadEducativa filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BasePersonasEntidadEducativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('personas_entidad_educativa_filters[%s]');
  ...
  {
    return 'PersonasEntidadEducativa';
  }
