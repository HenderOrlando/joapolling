...
/**
 * ArchivosEntidadEducativa filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 ...
 */
abstract class BaseArchivosEntidadEducativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id_tipo_uso'          => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Tipo'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'id_tipo_uso'          => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Tipo'), 'column' => 'id_tipo')),
    ...
    $this->widgetSchema->setNameFormat('archivos_entidad_educativa_filters[%s]');
